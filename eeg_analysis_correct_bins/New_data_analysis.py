...
with open('results_correct_800_all.pkl', 'wb') as f:
    pkl.dump([lr_di_vis, lr_fit_vis, lrq_di_vis, lrl_di_vis, lrq_fit_vis, lrl_fit_vis, 
              rl_di_vis, rl_fit_vis, rlq_di_vis, rll_di_vis, rlq_fit_vis, rll_fit_vis, 
              lr_di_mot, lr_fit_mot, lrq_di_mot, lrl_di_mot, lrq_fit_mot, lrl_fit_mot, 
              rl_di_mot, rl_fit_mot, rlq_di_mot, rll_di_mot, rlq_fit_mot, rll_fit_mot], f)
